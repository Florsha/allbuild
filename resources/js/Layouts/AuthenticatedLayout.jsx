...
import AdminLayout1 from '@/Layouts/AdminLayout';
import ClientLayout1 from '@/Layouts/ClientLayout';
...
export default function AuthenticatedLayout({ header, children }) {
  ...
  if (role === 1) {
    return <AdminLayout1 header={header}>{children}</AdminLayout1>;
  }

  if (role === 2) {
    return <ClientLayout1 header={header}>{children}</ClientLayout1>;
  }

  // fallback layout for undefined roles
  return (
